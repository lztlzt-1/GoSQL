...
func GetInitPage(GlobalDiskManager *diskMgr.DiskManager) *InitPage {
	this := InitPage{}
	magic, err := GlobalDiskManager.GetData(0, msg.MagicSize)
...
func (this *InitPage) SetInitPageToDisk(GlobalDiskManager *diskMgr.DiskManager) error {
